...
export const DEFAULT_CERTIFICATES: CertificateRecord[] = [
  {
    ...
    supervisingTutorId: 'tch-lawal',
    supervisingTutorName: 'Lawal Kehinde',
    supervisingTutorSlug: 'lawal-lead',
  ...
  },
  {
    ...
    supervisingTutorId: 'tch-precious',
    supervisingTutorName: 'Engr. Precious Ogunleye',
    supervisingTutorSlug: 'precious-creative-lead',
