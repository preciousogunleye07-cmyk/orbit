              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="p-5 rounded-[12px] bg-[#1f1b2e] hover:bg-[#332d47] border border-[#332d47] hover:border-[#8b5cf6]/50 text-left transition-all group"
                  >
            ...
            <div className="text-center py-4 animate-fade-in">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mb-4">
                <button
                  ...
                  className="btn-purple px-8 py-3.5 rounded-full font-semibold text-xs shadow-lg flex items-center gap-2"
                >
                ...
                <button
                  onClick={resetQuiz}
                  className="px-6 py-3.5 rounded-full bg-[#1f1b2e] hover:bg-[#332d47] border border-[#332d47] text-[#e2e8f0] hover:text-[#a855f7] text-xs font-medium flex items-center gap-1.5"
                >
