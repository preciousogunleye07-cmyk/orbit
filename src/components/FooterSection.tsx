          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2.5 pt-2">
              <button
                ...
                className="group px-3.5 py-2.5 rounded-xl bg-[#181524] hover:bg-[#231e34] border border-[#332d47] hover:border-emerald-500/40 text-[#e2e8f0] hover:text-[#ffffff] text-xs font-medium flex items-center gap-2.5 transition-all shadow-sm hover:shadow-emerald-950/20"
                id="footer-whatsapp"
              >
                <div className="w-6 h-6 rounded-lg bg-emerald-950/60 border border-emerald-800/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group px-3.5 py-2.5 rounded-xl bg-[#181524] hover:bg-[#231e34] border border-[#332d47] hover:border-pink-500/40 text-[#e2e8f0] hover:text-[#ffffff] text-xs font-medium flex items-center gap-2.5 transition-all shadow-sm hover:shadow-pink-950/20"
                id="footer-instagram"
              >
                <div className="w-6 h-6 rounded-lg bg-pink-950/60 border border-pink-800/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <svg className="w-3.5 h-3.5 fill-current text-pink-400 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group px-3.5 py-2.5 rounded-xl bg-[#181524] hover:bg-[#231e34] border border-[#332d47] hover:border-cyan-500/40 text-[#e2e8f0] hover:text-[#ffffff] text-xs font-medium flex items-center gap-2.5 transition-all shadow-sm hover:shadow-cyan-950/20"
                id="footer-tiktok"
              >
                <div className="w-6 h-6 rounded-lg bg-cyan-950/60 border border-cyan-800/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <svg className="w-3.5 h-3.5 fill-current text-cyan-400 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group px-3.5 py-2.5 rounded-xl bg-[#181524] hover:bg-[#231e34] border border-[#332d47] hover:border-sky-500/40 text-[#e2e8f0] hover:text-[#ffffff] text-xs font-medium flex items-center gap-2.5 transition-all shadow-sm hover:shadow-sky-950/20"
                id="footer-linkedin"
              >
                <div className="w-6 h-6 rounded-lg bg-sky-950/60 border border-sky-800/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <svg className="w-3.5 h-3.5 fill-current text-sky-400 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
