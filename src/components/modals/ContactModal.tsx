...
export const ContactModal: React.FC<ContactModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#100e17]/85 backdrop-blur-md animate-fade-in">
      <div className="bg-[#181524] border border-[#332d47] text-[#e2e8f0] rounded-[24px] w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 sm:p-8 relative shadow-2xl shadow-purple-950/40">
