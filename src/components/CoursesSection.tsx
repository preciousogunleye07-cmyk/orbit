...
export const CoursesSection: React.FC<CoursesSectionProps> = ({ setActiveModal }) => {
  ...
  return (
    <section id="courses" className="py-20 relative bg-[#100e17]">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between w-full">
                ...
                <div className="pt-4 border-t border-[#332d47] flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 py-2 px-3 rounded-full bg-[#181524] hover:bg-[#332d47] border border-[#332d47] text-xs font-medium text-[#e2e8f0] hover:text-[#a855f7] transition-all text-center"
                  >
                    Syllabus
                  </button>
                  <button
                    onClick={() => setActiveModal({ type: 'enroll', course })}
                    className="flex-1 py-2 px-3 rounded-full btn-purple text-xs font-semibold transition-all flex items-center justify-center gap-1 shadow-md"
                  >
                    <span>Enroll</span>
